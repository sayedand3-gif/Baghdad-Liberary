...
<html lang="ar" dir="rtl">
  <head>
    ...
    <title>نتائج البحث — مكتبة بغداد</title>
    ...
    <style>
      ...
      /* Layout Specific to Search Page */
      .search-layout {
        display: grid;
  ...
  <body>
    ...
    <main style="max-width: 1180px; margin: 0 auto; padding: 40px 24px">
      ...
      >
        <form style="display: flex; gap: 12px; flex-wrap: wrap">
          <input
            ...
            "
            placeholder="ابحث باسم الكتاب، المؤلف، أو الموضوع..."
          />
          <button type="submit" class="btn btn-gold">بحث جديد</button>
        </form>
        <div
          class="font-ui"
          style="margin-top: 14px; font-size: 0.85rem; color: var(--text-muted)"
        >
          تم العثور على
          <strong style="color: var(--gold-soft)">١٤ نتيجة</strong> للبحث عن
          "<strong style="color: var(--text-main)">ابن خلدون</strong>"
        </div>
      </div>
      ...
      <div class="search-layout">
        <!-- Filter Sidebar -->
        <aside class="filter-sidebar illum-frame">
          <h3
            class="font-title"
            style="
              font-size: 1.2rem;
          ...
          <div class="filter-group">
            ...
            <label class="filter-option">
              <input type="checkbox" checked /> التاريخ والاجتماع (٨)
            </label>
            <label class="filter-option">
              <input type="checkbox" /> الفلسفة والمنطق (٤)
            </label>
            <label class="filter-option">
              <input type="checkbox" /> الأدب والتراث (٢)
            </label>
          </div>
          ...
          <div class="filter-group">
            <h4>نوع المحتوى</h4>
            <label class="filter-option">
              <input type="checkbox" checked /> كتب مقروءة
            </label>
            <label class="filter-option">
              <input type="checkbox" /> كتب صوتية
            </label>
            <label class="filter-option">
              <input type="checkbox" /> ملخصات ومقالات
            </label>
          </div>
          ...
          <div class="filter-group">
            <h4>التقييم</h4>
            <label class="filter-option">
              <input type="checkbox" checked /> ★ 4.5 وأعلى
            </label>
            <label class="filter-option">
              <input type="checkbox" /> ★ 4.0 وأعلى
            </label>
          </div>

          <button
            class="btn btn-outline"
            style="width: 100%; font-size: 0.8rem; margin-top: 10px"
          >
            تطبيق الفلاتر
          </button>
        </aside>
        ...
        >
          ...
          <a href="../reader-module/book-details.php" class="book-card">
            <div
              ...
              "
            >
              <span class="font-title" style="font-size: 1.2rem; color: #fff"
          ...
          <a href="../reader-module/book-details.php" class="book-card">
            <div
              style="
                height: 240px;
                background: linear-gradient(135deg, #2b2418, #5b4a26);
                display: flex;
                align-items: flex-end;
                padding: 16px;
              "
          ...
          <a href="../reader-module/book-details.php" class="book-card">
            <div
              style="
                height: 240px;
                background: linear-gradient(135deg, #1c2a2b, #274b46);
                display: flex;
                align-items: flex-end;
                padding: 16px;
              "
          ...
          <a href="../reader-module/book-details.php" class="book-card">
            <div
              style="
                height: 240px;
                background: linear-gradient(135deg, #241826, #4a2b4f);
                display: flex;
                align-items: flex-end;
                padding: 16px;
              "
